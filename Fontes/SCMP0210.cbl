      ...
      *
       01 SS-INPUT-SCREEN.
           ...
           05 LINE 03 COL 05 VALUE "SMCP0210 - Inclusao".
      ...
      *
           IF FLAG-GRAVAR THEN
               IF WS-COD-PRODUTO  EQUAL   SPACES THEN
                   MOVE "CODIGO DE PRODUTO INVALIDO." TO WS-MENSAGEM
                   DISPLAY SS-LINHA-DE-MENSAGEM
                   ACCEPT WS-PROMPT AT 1401
                   DISPLAY SS-LIMPA-MENSAGEM
               ELSE
                   PERFORM P310-VALIDA-TIPO-PRODUTO THRU P310-FIM
                   IF FLAG-TP-PROD-VALIDO
                       PERFORM P320-GRAVA-PRODUTO THRU P320-FIM
                   END-IF
               END-IF
           END-IF.
      *
      ...
      *
       P320-GRAVA-PRODUTO.
      *
           WRITE   REG-PRODUTO         FROM    WS-REG-PRODUTO.

           IF WS-FS-PROD-OK THEN
               MOVE "PRODUTO CADATRADO OK"         TO WS-MENSAGEM
               DISPLAY SS-LINHA-DE-MENSAGEM
               ACCEPT WS-PROMPT AT 1401
               DISPLAY SS-LIMPA-MENSAGEM
           ELSE
               IF WS-FS-PRODUTO = "22" THEN
                   MOVE "PRODUTO JA CADATRADO"     TO WS-MENSAGEM
                   DISPLAY SS-LINHA-DE-MENSAGEM
                   ACCEPT WS-PROMPT AT 1401
                   DISPLAY SS-LIMPA-MENSAGEM
               ELSE
