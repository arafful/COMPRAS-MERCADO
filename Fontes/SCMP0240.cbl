      ...
      *
       01 SS-INPUT-SCREEN.
           ...
           05 LINE 03 COL 05 VALUE "SMCP0230 - Exclusao".
               ...
               KEY IS COD-PRODUTO
                   ...
                   NOT INVALID KEY
                       ...
                       IF FLAG-TP-PROD-VALIDO THEN
                           ...
                           DISPLAY WS-DESC-PRODUTO AT 0827
                           DISPLAY WS-FK-COD-TIPO  AT 1027
                           DISPLAY WS-DESC-TIPO    AT 1038
                           ACCEPT  SS-INPUT-SCREEN
                           IF FLAG-CONTINUAR THEN
                               PERFORM P400-DELETAR-PRODUTO
                                  THRU P400-FIM
                           END-IF
                       END-IF
               END-READ.
